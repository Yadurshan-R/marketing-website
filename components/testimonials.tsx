      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20 border-t border-gray-800">
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 mb-4 capitalize">Don't take our word for it</h2>
            <p className="text-xl capitalize text-gray-400">Here are a few reviews from our colleagues and students who have utilised this web application for their academic and professional success</p>
          </div>
          <div className="max-w-sm mx-auto grid gap-8 lg:grid-cols-3 lg:gap-6 items-start lg:max-w-none">
            <div className="flex flex-col h-full p-6 bg-gray-800 rounded-2xl" data-aos="fade-up">
              <div>
            ...
            <div className="flex flex-col h-full p-6 bg-gray-800 rounded-2xl" data-aos="fade-up" data-aos-delay="200">
              <div>
                <div className="relative inline-flex flex-col mb-4">
